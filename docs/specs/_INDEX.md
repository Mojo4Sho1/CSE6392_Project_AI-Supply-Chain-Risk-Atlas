...
- `summary`: local single-page Dash + Plotly showcase dashboard contract, including the swap-friendly renderer seam, required inputs/views/interactions, and runtime defaults.
