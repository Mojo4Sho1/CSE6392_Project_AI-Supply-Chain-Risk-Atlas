...
| T-031 | active | Dashboard redesign Stage 2: branding pass and visual refinement | `docs/dashboard_redesign_plan.md`, `CURRENT_STATUS.md` | Branding, panel styling, badges, legend, and empty states feel cohesive without changing analytical behavior |
