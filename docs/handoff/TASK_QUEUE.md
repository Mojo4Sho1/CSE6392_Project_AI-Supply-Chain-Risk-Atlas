...
| T-030 | done | Dashboard redesign Stage 1: new app shell, layout, and theme | `docs/dashboard_redesign_plan.md`, `dashboard-showcase.md`, `AGENTS.md` | Dashboard uses a graph-first app shell with top bar / left sidebar / center graph / right inspector, while preserving current analytical semantics and still using Plotly |
| T-031 | done | Dashboard redesign Stage 2: branding pass and visual refinement | `docs/dashboard_redesign_plan.md`, `CURRENT_STATUS.md` | Branding, panel styling, badges, legend, and empty states feel cohesive without changing analytical behavior |
| T-032 | queued | Dashboard redesign Stage 3: Cytoscape migration | `docs/dashboard_redesign_plan.md`, `dashboard-showcase.md`, `AGENTS.md` | Cytoscape replaces Plotly cleanly while preserving graph semantics, label strategy, and the existing data/view-model layer |
